...
from ui.tabs.rotaciones import tab_rotaciones as tab_rotaciones_modular
...
def main() -> None:
    ...
    with pestañas[3]:
        tab_jacobiano_modular(vector_entrada, A_TABLA)
    with pestañas[4]:
        tab_dinamica_modular(vector_entrada, A_TABLA)
    with pestañas[5]:
        tab_trayectorias_modular(vector_entrada, A_GRAFICA)
    with pestañas[6]:
